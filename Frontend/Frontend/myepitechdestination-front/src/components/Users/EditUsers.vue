<template>
   <div>
        <h4 class="text-center mt-20">
            <small>
            <button class="btn btn-success" v-on:click="navigate()"> Retour Crud Utilisateur </button>
            </small>
        </h4>
        <div class="col-md-12 form-wrapper">
            ...
            <form id="create-post-form" @submit.prevent="edituser(id)">
                ...
                <div class="form-group col-md-12" v-for="role in user.roles" :key="role.id">
                    <label for="title"> Rôles </label>
                    <input type="text" id="rôles" v-model="role.nom" name="title" class="form-control" placeholder="Changer de rôle (admin ou user)">
                </div>  

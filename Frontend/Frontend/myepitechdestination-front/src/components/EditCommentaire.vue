<template>
  <div>
    <BoardAdmin />
    <div class="back">
      <router-link to="/crudUtilisateurs"
        ...
        <form id="create-post-form" @submit.prevent="editcommentaire(id)">
          <div class="form-group col-md-12">
            ...
            <input
              type="text"
              id="nom"
              v-model="commentaire.nom"
              name="nom"
              class="form-control"
              placeholder="Un nom différent ?"
            />
          </div>
          <div class="form-group col-md-12">
          ...
          <div class="form-group col-md-12">
            ...
            <input
              type="text"
              id="articleId"
              v-model="commentaire.articleId"
              name="articleId"
              class="form-control"
              placeholder="Changer l'articleId "
            />
          </div>
          <div class="form-group col-md-12">
...
export default {
  ...
  methods: {
    editcommentaire(id) {
      ...
      axios
        .put(
          "http://localhost:8080/api" + "/commentaires/" + id,
          commentaireData
        )
        .then((data) => {
          router.push({ name: "CrudCommentaires" }), console.log(data);
        });
    },
    getcommentaire(id) {
      axios

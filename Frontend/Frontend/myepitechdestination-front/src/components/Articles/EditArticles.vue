<template>
   <div>
        <h4 class="text-center mt-20">
            <small>
            <button class="btn btn-success" v-on:click="navigate()"> Crud Article </button>
            </small>
        </h4>
        <div class="col-md-12 form-wrapper">
            ...
            <form id="create-post-form" @submit.prevent="editarticle(id)">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea type="text" id="description" v-model="article.description" name="title" class="form-control" placeholder="Un description ....">
                    </textarea>
                </div> 

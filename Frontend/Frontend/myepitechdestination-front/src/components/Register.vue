  ...
  <div class="container">
    <div class="row">
      <div class="col-md d-none d-lg-block">
        <img
          src="../assets/image-register-write2.jpg"
      ...
      <div class="col-md" id="container2">
        <p class="register">
          Déjà membre ? <a href="/login"><button>Se connecter</button></a>
        </p>
...
export default {
  ...
  data() {
    const schema = yup.object().shape({
      nom: yup.string().required("Un nom est nécessaire!"),
      prénom: yup.string().required("Un prénom est nécessaire!"),
      email: yup
        .string()
